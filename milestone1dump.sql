...
(1, 'Administrator', 'Administrator', 'Y', NULL, NULL, NULL, NULL, NULL, 'Admin', 'Admin', 'Admin'),
...
(7, 'rstantz', '"; INSERT INTO Customers (CustomerName,Address,City) Values(@0,@1,@2); --', '', NULL, NULL, NULL, NULL, NULL, 'User', 'rstantz', ''),
